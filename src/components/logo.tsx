/**
 * The Georgia Tech mark. An identity, not decoration — it is sized to the text
 * beside it and never grows. The navy path lifts in dark mode so the mark does
 * not disappear into the background; the gold is left alone.
 */
export function GtLogo({ className }: { className?: string }) {
  return (
    <svg
    ...
    >
      <g transform="matrix(.81578 0 0 .81578 1.1766 1.1197)">
        <path
          className="fill-[#003057] dark:fill-[#7ba7cd]"
